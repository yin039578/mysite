...
const apiConfig = {
    ...
    path: '/api/hostcenter/event/notify_template/list',      // API endpoint path
    baseURL: 'https://api.meet.104dc-dev.com'  // Base URL of your API
};
...
const config = {
    ...
    testParams: [
        {
            ...
            body: {
                ...
                "page": 1,
                "filter_type": 1,
                "event_id": "ab8b378a-ae3c-4a7a-aa7f-c4d4eb00bbdc",
                "notify_type": 0,
                "host_id": "71"
            }
        },
    ...
    iterationsPerVU: 100,    // Number of iterations per VU
    sleepDuration: 0,      // Sleep duration between requests in seconds
};
